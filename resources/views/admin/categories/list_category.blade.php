                        ...
                        <table id="category_table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-warning btn-sm" href="{{ route('category.edit', $category->id) }}"><i class="fas fa-edit"></i>Sửa</a>
                                    </td>
                                    <td>
                                        <form action="{{ route('category.destroy', $category->id) }}" method="post">
                                            @csrf
                                            <input name="_method" type="hidden" value="DELETE">
                                            <button type="button" class="btn btn-danger btn-sm delete-category"><i class="fas fa-trash-alt"></i> Xóa</button>
                                        </form>
                                    </td>
                                </tr>
                                @php
