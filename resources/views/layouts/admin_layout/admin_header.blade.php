            ...
            <ul class="navbar-nav float-left mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-none d-md-block"><i class="mdi mdi-library-plus"></i> Thêm mới <i class="fa fa-angle-down"></i></span>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i> Thông tin cá nhân</a>
                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-wallet m-r-5 m-l-5"></i> My Balance</a>
                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-email m-r-5 m-l-5"></i> Hộp thư</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/system-cpanel/settings') }}"><i class="ti-settings m-r-5 m-l-5"></i> Cài đặt</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ url('/logout') }}"><i class="fa fa-power-off m-r-5 m-l-5"></i> Thoát</a>
                        <div class="dropdown-divider"></div>
